...
payasos = 112
muñecas = 75
cant = int(input ("Ingrese la cantidad de Payasos vendidos: "))
cant2 = int (input("Ingrese la cantidad de Muñecas vendidos: "))
venta1 = cant * 112
venta2 = cant2 * 75
pedido = venta1 + venta2
print("El peso total del pedido es:", pedido, "g que sera enviado ")